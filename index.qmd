---
title: "ISSS608-VAA Hands-on Exercise 1"
---
...
This code chunk creates a histogram for the variable `MATHS` in `exam_data`.
It helps us understand the distribution of students' maths scores.
The argument `bins = 10` groups the scores into 10 intervals.
`color = "black"` sets the border color of each bar, and `fill = "grey"` sets the bar color.
The title makes the chart easier to interpret.
